...
contract TokenTransferor is OwnerIsCreator {
    ...
    error NothingToWithdraw(); // Used when trying to withdraw Ether but there'ProgrammableTokenTransfers.sol nothing to withdraw.
    ...
    returns (bytes32 messageId)
    {
        ...
        // approve the Router to transfer LINK tokens on contract'ProgrammableTokenTransfers.sol behalf. It will spend the fees in LINK
        linkToken.approve(address(router), fees);

        // approve the Router to spend tokens on contract'ProgrammableTokenTransfers.sol behalf. It will spend the amount of the given token
